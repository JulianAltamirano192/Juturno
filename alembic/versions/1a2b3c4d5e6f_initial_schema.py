...
def upgrade():
    ...
    op.create_index(
        op.f("ix_service_is_active"), "service", ["is_active"], unique=False
    )
    op.create_index(
        op.f("ix_service_tenant_id"), "service", ["tenant_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "start_time", sa.DateTime(timezone=True), nullable=False
        ),  # Slot como DateTime
        sa.Column(
            "end_time", sa.DateTime(timezone=True), nullable=False
        ),  # Slot como DateTime
        sa.Column(
    ...
    op.create_index(
        op.f("ix_booking_service_id"), "booking", ["service_id"], unique=False
    )
    op.create_index(op.f("ix_booking_staff_id"), "booking", ["staff_id"], unique=False)
    op.create_index(
        op.f("ix_booking_start_time"), "booking", ["start_time"], unique=False
    )
    op.create_index(op.f("ix_booking_status"), "booking", ["status"], unique=False)
    op.create_index(
        op.f("ix_booking_tenant_id"), "booking", ["tenant_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_payment_booking_id"), "payment", ["booking_id"], unique=False
    )
    op.create_index(op.f("ix_payment_status"), "payment", ["status"], unique=False)
    op.create_index(
        op.f("ix_payment_mp_payment_id"), "payment", ["mp_payment_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_notification_outbox_booking_id"),
        "notification_outbox",
        ["booking_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_payment_events_booking_id"),
        "payment_events",
        ["booking_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_payment_events_event_id"), "payment_events", ["event_id"], unique=False
    )
    op.create_index(
        op.f("ix_payment_events_status"), "payment_events", ["status"], unique=False
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_notification_outbox_status"), table_name="notification_outbox"
    )
    op.drop_index(
        op.f("ix_notification_outbox_booking_id"), table_name="notification_outbox"
    )
