...
async def test_booking_two_tenants_same_time_no_staff(db_session):
    ...
    service_a = Service(
        tenant_id=tenant_a.id, name="Servicio A", duration_minutes=60, price=100.0
    )
    service_b = Service(
        tenant_id=tenant_b.id, name="Servicio B", duration_minutes=60, price=100.0
    )
...
async def test_booking_same_tenant_same_time_no_staff_fails(db_session):
    ...
    service = Service(
        tenant_id=tenant.id, name="Servicio C", duration_minutes=60, price=100.0
    )
